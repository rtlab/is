!function ( e ) {
	if ( "object" == typeof exports )module.exports = e(); else if ( "function" == typeof define && define.amd )define( e ); else {
		var f;
		"undefined" != typeof window ? f = window : "undefined" != typeof global ? f = global : "undefined" != typeof self && (f = self), f.when = e()
	}
}( function () {
	...
	return (function e ( t, n, r ) {
		...
		var when = module.exports = _dereq_( '../when' );

		when.callbacks = _dereq_( '../callbacks' );
		when.cancelable = _dereq_( '../cancelable' );
		when.delay = _dereq_( '../delay' );
		when.fn = _dereq_( '../function' );
		when.guard = _dereq_( '../guard' );
		when.keys = _dereq_( '../keys' );
		when.nodefn = _dereq_( '../node/function' );
		when.parallel = _dereq_( '../parallel' );
		when.pipeline = _dereq_( '../pipeline' );
		when.poll = _dereq_( '../poll' );
		when.sequence = _dereq_( '../sequence' );
		when.timeout = _dereq_( '../timeout' );

	}, {"../callbacks" : 2, "../cancelable" : 3, "../delay" : 4, "../function" : 5, "../guard" : 6, "../keys" : 7, "../node/function" : 8, "../parallel" : 9, "../pipeline" : 10, "../poll" : 11, "../sequence" : 12, "../timeout" : 13, "../when" : 14}], 2 : [function ( _dereq_, module, exports ) {
	...
	}, {"./when" : 14}], 3                                                                                                                                                                                                                                   : [function ( _dereq_, module, exports ) {
	...
	}, {"./when" : 14}], 4                                                                                                                                                                                                                                   : [function ( _dereq_, module, exports ) {
	...
	}, {"./when" : 14}], 5                                                                                                                                                                                                                                   : [function ( _dereq_, module, exports ) {
		/** @license MIT License (c) copyright 2013 original author or authors */
	...
	}, {"./when" : 14}], 6                                                                                                                                                                                                                                   : [function ( _dereq_, module, exports ) {
		/** @license MIT License (c) copyright 2011-2013 original author or authors */
	...
	}, {"./when" : 14}], 7                                                                                                                                                                                                                                   : [function ( _dereq_, module, exports ) {
		/** @license MIT License (c) copyright 2011-2013 original author or authors */
	...
	}, {"./when" : 14}], 8                                                                                                                                                                                                                                   : [function ( _dereq_, module, exports ) {
		/** @license MIT License (c) copyright 2013 original author or authors */
	...
	}, {"../when" : 14}], 9                                                                                                                                                                                                                                  : [function ( _dereq_, module, exports ) {
		/** @license MIT License (c) copyright 2011-2013 original author or authors */
	...
	}, {"./when" : 14}], 10                                                                                                                                                                                                                                  : [function ( _dereq_, module, exports ) {
		/** @license MIT License (c) copyright 2011-2013 original author or authors */
	...
	}, {"./when" : 14}], 11                                                                                                                                                                                                                                  : [function ( _dereq_, module, exports ) {
	...
	}, {"./cancelable" : 3, "./delay" : 4, "./function" : 5, "./when" : 14}], 12                                                                                                                                                                             : [function ( _dereq_, module, exports ) {
		/** @license MIT License (c) copyright 2011-2013 original author or authors */
	...
	}, {"./when" : 14}], 13                                                                                                                                                                                                                                  : [function ( _dereq_, module, exports ) {
		/** @license MIT License (c) copyright 2011-2013 original author or authors */
	...
	}, {"./when" : 14}], 14                                                                                                                                                                                                                                  : [function ( _dereq_, module, exports ) {
		(function ( process ) {
			/** @license MIT License (c) copyright 2011-2013 original author or authors */
	 ...
	 * }}}
		...
		}).call( this, _dereq_( "Z:\\Users\\Andrey\\AppData\\Roaming\\npm\\node_modules\\browserify\\node_modules\\insert-module-globals\\node_modules\\process\\browser.js" ) )
	}, {"Z:\\Users\\Andrey\\AppData\\Roaming\\npm\\node_modules\\browserify\\node_modules\\insert-module-globals\\node_modules\\process\\browser.js" : 15}], 15                                                                                              : [function ( _dereq_, module, exports ) {
